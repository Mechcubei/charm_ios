...
class Toast {
  ...
  class func show(text: String?,type: Theme,changeBackground:Bool = false){
    ...
    view.backgroundColor = ENUMCOLOUR.themeColour.getColour()
...
//
    ...
    view.configureContent(title: "WARNING!", body:text, iconImage: nil, iconText: nil, buttonImage: nil, buttonTitle: "OK") { (button) in
        SwiftMessages.hide()
    }
